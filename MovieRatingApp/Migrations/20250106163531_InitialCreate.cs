    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "High energy, lots of stunts", "Action" },
                    { 2, "Funny and lighthearted", "Comedy" },
                    { 3, "Serious and emotional stories", "Drama" }
                });

            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "MovieID", "Description", "ReleaseYear", "Title" },
                values: new object[,]
                {
                    { 1, "A mind-bending thriller", 2010, "Inception" },
                    { 2, "Batman battles Joker", 2008, "The Dark Knight" }
                });
