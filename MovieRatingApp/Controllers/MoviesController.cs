...
namespace MovieRatingApp.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MovieID,Title,Description,ReleaseYear")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MovieID,Title,Description,ReleaseYear")] Movie movie)
        {
            if (id != movie.MovieID)
            {
                return NotFound();
